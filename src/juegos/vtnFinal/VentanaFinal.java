package juegos.vtnFinal;

import java.util.Timer;
import java.util.TimerTask;
import javax.swing.JOptionPane;
import juegos.SongThread;
import juegos.Reproductor;
...
public class VentanaFinal extends javax.swing.JFrame {
    ...
    public VentanaFinal(String nombre) {
        ...
        String mensaje = "FELICIDADES "+nombre.toUpperCase();
        
        this.jLabel2.setText(mensaje.toUpperCase());
        SongThread musica = new SongThread("baile.wav");
        musica.start();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/juegos/vtnFinal/baile.gif"))); // NOI18N
...
//            public void run() {
//                new VentanaFinal("Joctan").setVisible(true);
//            }
//        });
//    }
